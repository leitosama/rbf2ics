...
```bash
rbf2ics$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
rbf2ics$ sam logs -n HelloWorldFunction --stack-name "rbf2ics" --tail
```
